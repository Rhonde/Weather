...
public:
	...
	/// Connect to Dfsdm1
	using Ckin7 = GpioSignal;
	/// Connect to Quadspi
	using Ncs = GpioSignal;
	/// Connect to Comp2
	...
	template< Peripheral peripheral >
	struct Ckin7 { static void connect();
		static_assert(
			(peripheral == Peripheral::Dfsdm1),
			"GpioB11::Ckin7 only connects to Dfsdm1!");
	};
	template< Peripheral peripheral >
	struct Ncs { static void connect();
		static_assert(
			(peripheral == Peripheral::Quadspi),
			"GpioB11::Ncs only connects to Quadspi!");
	};
	template< Peripheral peripheral >
	struct Out { static void connect();
		static_assert(
			(peripheral == Peripheral::Comp2),
			"GpioB11::Out only connects to Comp2!");
	};
	template< Peripheral peripheral >
	...
	template< Peripheral peripheral >
	struct Seg11 { static void connect();
		static_assert(
			(peripheral == Peripheral::Lcd),
			"GpioB11::Seg11 only connects to Lcd!");
	};
	template< Peripheral peripheral >
...
template<>
struct GpioB11::Ckin7<Peripheral::Dfsdm1>
{
	using Gpio = GpioB11;
...
template<>
struct GpioB11::Ncs<Peripheral::Quadspi>
{
	using Gpio = GpioB11;
...
template<>
struct GpioB11::Out<Peripheral::Comp2>
{
	using Gpio = GpioB11;
...
template<>
struct GpioB11::Sda<Peripheral::I2c2>
{
	using Gpio = GpioB11;
...
template<>
struct GpioB11::Seg11<Peripheral::Lcd>
{
	using Gpio = GpioB11;
