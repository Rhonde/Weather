...
#ifndef MODM_STM32_GPIO_PIN_B9_HPP
#define MODM_STM32_GPIO_PIN_B9_HPP
...
class GpioB9 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioB9>;
	friend class Adc;
...
public:
	...
	/// Connect to Dfsdm1
	using Ckin6 = GpioSignal;
	/// Connect to Lcd
	using Com3 = GpioSignal;
	/// Connect to Sdmmc1
	using D5 = GpioSignal;
	/// Connect to Sai1
...
/// @cond
template<>
struct GpioB9::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioB9;
...
template<>
struct GpioB9::Ch1<Peripheral::Tim17>
{
	using Gpio = GpioB9;
...
template<>
struct GpioB9::Ch4<Peripheral::Tim4>
{
	using Gpio = GpioB9;
...
template<>
struct GpioB9::Ckin6<Peripheral::Dfsdm1>
{
	using Gpio = GpioB9;
...
template<>
struct GpioB9::Com3<Peripheral::Lcd>
{
	using Gpio = GpioB9;
...
template<>
struct GpioB9::D5<Peripheral::Sdmmc1>
{
	using Gpio = GpioB9;
...
template<>
struct GpioB9::FsA<Peripheral::Sai1>
{
	using Gpio = GpioB9;
...
template<>
struct GpioB9::IrOut<Peripheral::None>
{
	using Gpio = GpioB9;
...
template<>
struct GpioB9::Nss<Peripheral::Spi2>
{
	using Gpio = GpioB9;
...
template<>
struct GpioB9::Sda<Peripheral::I2c1>
{
	using Gpio = GpioB9;
...
template<>
struct GpioB9::Tx<Peripheral::Can1>
{
	using Gpio = GpioB9;
...
#endif // MODM_STM32_GPIO_PIN_B9_HPP