...
public:
	...
	struct Ck { static void connect();
		static_assert(
			...
			"GpioB5::Ck only connects to Usart1!");
	};
	template< Peripheral peripheral >
	...
	template< Peripheral peripheral >
	struct G2Io2 { static void connect();
		static_assert(
			(peripheral == Peripheral::Tsc),
			"GpioB5::G2Io2 only connects to Tsc!");
	};
	template< Peripheral peripheral >
	...
	struct Out { static void connect();
		static_assert(
			...
			"GpioB5::Out only connects to Comp2!");
	};
	template< Peripheral peripheral >
	...
	template< Peripheral peripheral >
	struct Seg9 { static void connect();
		static_assert(
			(peripheral == Peripheral::Lcd),
			"GpioB5::Seg9 only connects to Lcd!");
	};
	template< Peripheral peripheral >
...
template<>
struct GpioB5::Ck<Peripheral::Usart1>
{
	using Gpio = GpioB5;
...
template<>
struct GpioB5::G2Io2<Peripheral::Tsc>
{
	using Gpio = GpioB5;
...
template<>
struct GpioB5::Out<Peripheral::Comp2>
{
	using Gpio = GpioB5;
...
template<>
struct GpioB5::Seg9<Peripheral::Lcd>
{
	using Gpio = GpioB5;
