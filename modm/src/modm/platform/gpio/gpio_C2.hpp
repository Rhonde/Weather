...
public:
	...
	template< Peripheral peripheral >
	struct Ckout { static void connect();
		static_assert(
			(peripheral == Peripheral::Dfsdm1),
			"GpioC2::Ckout only connects to Dfsdm1!");
	};
	template< Peripheral peripheral >
	struct In2 { static void connect();
		static_assert(
			(peripheral == Peripheral::Lptim1),
			"GpioC2::In2 only connects to Lptim1!");
	};
	template< Peripheral peripheral >
	struct In3 { static void connect();
		static_assert(
			...
			"GpioC2::In3 only connects to Adc1 or Adc2 or Adc3!");
	};
	template< Peripheral peripheral >
	...
	template< Peripheral peripheral >
	struct Seg20 { static void connect();
		static_assert(
			(peripheral == Peripheral::Lcd),
			"GpioC2::Seg20 only connects to Lcd!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
template<>
struct GpioC2::Ckout<Peripheral::Dfsdm1>
{
	using Gpio = GpioC2;
...
template<>
struct GpioC2::In2<Peripheral::Lptim1>
{
	using Gpio = GpioC2;
...
template<>
struct GpioC2::In3<Peripheral::Adc1>
{
	using Gpio = GpioC2;
...
template<>
constexpr int8_t
GpioC2::AdcChannel<Peripheral::Adc1> = 3;
template<>
struct GpioC2::In3<Peripheral::Adc2>
{
	using Gpio = GpioC2;
	static constexpr Gpio::Signal Signal = Gpio::Signal::In3;
	static constexpr int af = -1;
...
template<>
constexpr int8_t
GpioC2::AdcChannel<Peripheral::Adc2> = 3;
template<>
struct GpioC2::In3<Peripheral::Adc3>
{
	using Gpio = GpioC2;
	static constexpr Gpio::Signal Signal = Gpio::Signal::In3;
	static constexpr int af = -1;
...
template<>
constexpr int8_t
GpioC2::AdcChannel<Peripheral::Adc3> = 3;
template<>
...
template<>
struct GpioC2::Seg20<Peripheral::Lcd>
{
	using Gpio = GpioC2;
