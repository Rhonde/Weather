...
#ifndef MODM_STM32_GPIO_PIN_C15_HPP
#define MODM_STM32_GPIO_PIN_C15_HPP
...
class GpioC15 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioC15>;
	friend class Adc;
	friend class Adc1; friend class Adc2;
	friend class Adc3; friend class Adc4;
public:
	using Output = GpioC15;
	using Input = GpioC15;
	using IO = GpioC15;
	using Type = GpioC15;
...
public:
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioC15::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
	struct Osc32Out { static void connect();
		static_assert(
			(peripheral == Peripheral::Rcc),
			"GpioC15::Osc32Out only connects to Rcc!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioC15::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioC15;
...
template<>
struct GpioC15::Osc32Out<Peripheral::Rcc>
{
	using Gpio = GpioC15;
...
#endif // MODM_STM32_GPIO_PIN_C15_HPP