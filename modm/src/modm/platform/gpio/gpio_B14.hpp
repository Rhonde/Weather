...
public:
	...
	/// Connect to Dfsdm1
	using Datin2 = GpioSignal;
	/// Connect to Usart3
	using De = GpioSignal;
	/// Connect to Tsc
	using G1Io3 = GpioSignal;
	/// Connect to Sai2
	...
	template< Peripheral peripheral >
	struct Datin2 { static void connect();
		static_assert(
			(peripheral == Peripheral::Dfsdm1),
			"GpioB14::Datin2 only connects to Dfsdm1!");
	};
	template< Peripheral peripheral >
	...
	template< Peripheral peripheral >
	struct G1Io3 { static void connect();
		static_assert(
			(peripheral == Peripheral::Tsc),
			"GpioB14::G1Io3 only connects to Tsc!");
	};
	template< Peripheral peripheral >
	struct MclkA { static void connect();
		static_assert(
			(peripheral == Peripheral::Sai2),
			"GpioB14::MclkA only connects to Sai2!");
	};
	template< Peripheral peripheral >
	...
	struct Rx { static void connect();
		static_assert(
			...
			"GpioB14::Rx only connects to Swpmi1!");
	};
	template< Peripheral peripheral >
	...
	template< Peripheral peripheral >
	struct Seg14 { static void connect();
		static_assert(
			(peripheral == Peripheral::Lcd),
			"GpioB14::Seg14 only connects to Lcd!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
template<>
struct GpioB14::Ch2n<Peripheral::Tim8>
{
	using Gpio = GpioB14;
	static constexpr Gpio::Signal Signal = Gpio::Signal::Ch2n;
...
template<>
struct GpioB14::Datin2<Peripheral::Dfsdm1>
{
	using Gpio = GpioB14;
...
template<>
struct GpioB14::G1Io3<Peripheral::Tsc>
{
	using Gpio = GpioB14;
...
template<>
struct GpioB14::MclkA<Peripheral::Sai2>
{
	using Gpio = GpioB14;
...
template<>
struct GpioB14::Rx<Peripheral::Swpmi1>
{
	using Gpio = GpioB14;
...
template<>
struct GpioB14::Seg14<Peripheral::Lcd>
{
	using Gpio = GpioB14;
