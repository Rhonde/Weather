...
public:
	...
	using Ck = GpioSignal;
	/// Connect to Dfsdm1
	using Datin1 = GpioSignal;
	/// Connect to Lpuart1
	using De = GpioSignal;
	/// Connect to Sai2
	using FsA = GpioSignal;
	/// Connect to Tsc
	using G1Io1 = GpioSignal;
	/// Connect to Swpmi1
	using Io = GpioSignal;
	/// Connect to Spi2
	...
	struct Bkin { static void connect();
		static_assert(
			...
			"GpioB12::Bkin only connects to Tim1 or Tim15!");
	};
	template< Peripheral peripheral >
	struct BkinComp2 { static void connect();
		static_assert(
			(peripheral == Peripheral::Tim1),
			"GpioB12::BkinComp2 only connects to Tim1!");
	};
	template< Peripheral peripheral >
	...
	template< Peripheral peripheral >
	struct Datin1 { static void connect();
		static_assert(
			(peripheral == Peripheral::Dfsdm1),
			"GpioB12::Datin1 only connects to Dfsdm1!");
	};
	template< Peripheral peripheral >
	...
	struct FsA { static void connect();
		static_assert(
			...
			"GpioB12::FsA only connects to Sai2!");
	};
	template< Peripheral peripheral >
	struct G1Io1 { static void connect();
		static_assert(
			(peripheral == Peripheral::Tsc),
			"GpioB12::G1Io1 only connects to Tsc!");
	};
	template< Peripheral peripheral >
	struct Io { static void connect();
		static_assert(
			(peripheral == Peripheral::Swpmi1),
			"GpioB12::Io only connects to Swpmi1!");
	};
	template< Peripheral peripheral >
	...
	template< Peripheral peripheral >
	struct Seg12 { static void connect();
		static_assert(
			(peripheral == Peripheral::Lcd),
			"GpioB12::Seg12 only connects to Lcd!");
	};
	template< Peripheral peripheral >
...
template<>
struct GpioB12::Bkin<Peripheral::Tim15>
{
	using Gpio = GpioB12;
	static constexpr Gpio::Signal Signal = Gpio::Signal::Bkin;
...
template<>
struct GpioB12::BkinComp2<Peripheral::Tim1>
{
	using Gpio = GpioB12;
...
template<>
struct GpioB12::Datin1<Peripheral::Dfsdm1>
{
	using Gpio = GpioB12;
...
template<>
struct GpioB12::FsA<Peripheral::Sai2>
{
	using Gpio = GpioB12;
...
template<>
struct GpioB12::G1Io1<Peripheral::Tsc>
{
	using Gpio = GpioB12;
...
template<>
struct GpioB12::Io<Peripheral::Swpmi1>
{
	using Gpio = GpioB12;
...
template<>
struct GpioB12::Seg12<Peripheral::Lcd>
{
	using Gpio = GpioB12;
