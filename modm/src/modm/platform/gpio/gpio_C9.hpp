...
public:
	...
	/// Connect to Tsc
	using G4Io4 = GpioSignal;
	/// Connect to UsbOtgFs
	using Noe = GpioSignal;
	/// Connect to Lcd
	using Seg27 = GpioSignal;
	/// @}
#endif
	/// @cond
	...
	struct Bkin2 { static void connect();
		static_assert(
			...
			"GpioC9::Bkin2 only connects to Tim8!");
	};
	template< Peripheral peripheral >
	struct Bkin2Comp1 { static void connect();
		static_assert(
			(peripheral == Peripheral::Tim8),
			"GpioC9::Bkin2Comp1 only connects to Tim8!");
	};
	template< Peripheral peripheral >
	...
	struct Extclk { static void connect();
		static_assert(
			...
			"GpioC9::Extclk only connects to Sai2!");
	};
	template< Peripheral peripheral >
	struct G4Io4 { static void connect();
		static_assert(
			(peripheral == Peripheral::Tsc),
			"GpioC9::G4Io4 only connects to Tsc!");
	};
	template< Peripheral peripheral >
	struct Noe { static void connect();
		static_assert(
			(peripheral == Peripheral::UsbOtgFs),
			"GpioC9::Noe only connects to UsbOtgFs!");
	};
	template< Peripheral peripheral >
	struct Seg27 { static void connect();
		static_assert(
			(peripheral == Peripheral::Lcd),
			"GpioC9::Seg27 only connects to Lcd!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
template<>
struct GpioC9::Bkin2<Peripheral::Tim8>
{
	using Gpio = GpioC9;
...
template<>
struct GpioC9::Bkin2Comp1<Peripheral::Tim8>
{
	using Gpio = GpioC9;
...
template<>
struct GpioC9::Extclk<Peripheral::Sai2>
{
	using Gpio = GpioC9;
...
template<>
struct GpioC9::G4Io4<Peripheral::Tsc>
{
	using Gpio = GpioC9;
...
template<>
struct GpioC9::Noe<Peripheral::UsbOtgFs>
{
	using Gpio = GpioC9;
...
template<>
struct GpioC9::Seg27<Peripheral::Lcd>
{
	using Gpio = GpioC9;
