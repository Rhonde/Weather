...
public:
	...
	/// Connect to Tim8
	using Bkin2Comp2 = GpioSignal;
	/// Connect to Tim4
	using Ch1 = GpioSignal;
	/// Connect to Tim16
	using Ch1n = GpioSignal;
	/// Connect to Dfsdm1
	using Datin5 = GpioSignal;
	/// Connect to Lptim1
	...
	template< Peripheral peripheral >
	struct Bkin2Comp2 { static void connect();
		static_assert(
			(peripheral == Peripheral::Tim8),
			"GpioB6::Bkin2Comp2 only connects to Tim8!");
	};
	template< Peripheral peripheral >
	...
	template< Peripheral peripheral >
	struct Datin5 { static void connect();
		static_assert(
			(peripheral == Peripheral::Dfsdm1),
			"GpioB6::Datin5 only connects to Dfsdm1!");
	};
	template< Peripheral peripheral >
...
template<>
struct GpioB6::Bkin2Comp2<Peripheral::Tim8>
{
	using Gpio = GpioB6;
...
template<>
struct GpioB6::Datin5<Peripheral::Dfsdm1>
{
	using Gpio = GpioB6;
