...
#ifndef MODM_STM32_GPIO_PIN_H0_HPP
#define MODM_STM32_GPIO_PIN_H0_HPP
...
class GpioH0 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioH0>;
	friend class Adc;
...
public:
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioH0::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
	struct OscIn { static void connect();
		static_assert(
			(peripheral == Peripheral::Rcc),
			"GpioH0::OscIn only connects to Rcc!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioH0::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioH0;
...
template<>
struct GpioH0::OscIn<Peripheral::Rcc>
{
	using Gpio = GpioH0;
...
#endif // MODM_STM32_GPIO_PIN_H0_HPP