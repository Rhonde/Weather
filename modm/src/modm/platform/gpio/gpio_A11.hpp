...
#ifndef MODM_STM32_GPIO_PIN_A11_HPP
#define MODM_STM32_GPIO_PIN_A11_HPP
...
class GpioA11 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioA11>;
	friend class Adc;
	friend class Adc1; friend class Adc2;
	friend class Adc3; friend class Adc4;
public:
	using Output = GpioA11;
	using Input = GpioA11;
	using IO = GpioA11;
	using Type = GpioA11;
...
public:
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioA11::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
	struct Bkin2 { static void connect();
		static_assert(
			(peripheral == Peripheral::Tim1),
			"GpioA11::Bkin2 only connects to Tim1!");
	};
	template< Peripheral peripheral >
	struct Bkin2Comp1 { static void connect();
		static_assert(
			(peripheral == Peripheral::Tim1),
			"GpioA11::Bkin2Comp1 only connects to Tim1!");
	};
	template< Peripheral peripheral >
	struct Ch4 { static void connect();
		static_assert(
			(peripheral == Peripheral::Tim1),
			"GpioA11::Ch4 only connects to Tim1!");
	};
	template< Peripheral peripheral >
	struct Cts { static void connect();
		static_assert(
			(peripheral == Peripheral::Usart1),
			"GpioA11::Cts only connects to Usart1!");
	};
	template< Peripheral peripheral >
	struct Dm { static void connect();
		static_assert(
			(peripheral == Peripheral::UsbOtgFs),
			"GpioA11::Dm only connects to UsbOtgFs!");
	};
	template< Peripheral peripheral >
	struct Rx { static void connect();
		static_assert(
			(peripheral == Peripheral::Can1),
			"GpioA11::Rx only connects to Can1!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioA11::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioA11;
...
template<>
struct GpioA11::Bkin2<Peripheral::Tim1>
{
	using Gpio = GpioA11;
...
template<>
struct GpioA11::Bkin2Comp1<Peripheral::Tim1>
{
	using Gpio = GpioA11;
...
template<>
struct GpioA11::Ch4<Peripheral::Tim1>
{
	using Gpio = GpioA11;
...
template<>
struct GpioA11::Cts<Peripheral::Usart1>
{
	using Gpio = GpioA11;
...
template<>
struct GpioA11::Dm<Peripheral::UsbOtgFs>
{
	using Gpio = GpioA11;
...
template<>
struct GpioA11::Rx<Peripheral::Can1>
{
	using Gpio = GpioA11;
...
#endif // MODM_STM32_GPIO_PIN_A11_HPP