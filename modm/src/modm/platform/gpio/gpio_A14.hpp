...
#ifndef MODM_STM32_GPIO_PIN_A14_HPP
#define MODM_STM32_GPIO_PIN_A14_HPP
...
class GpioA14 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioA14>;
	friend class Adc;
	friend class Adc1; friend class Adc2;
	friend class Adc3; friend class Adc4;
public:
	using Output = GpioA14;
	using Input = GpioA14;
	using IO = GpioA14;
	using Type = GpioA14;
...
public:
	...
	/// Connect to Sys
	using Jtck = GpioSignal;
	/// Connect to Sys
	using Swclk = GpioSignal;
	/// @}
#endif
	/// @cond
	...
	struct BitBang { static void connect();
		static_assert(
			...
			"GpioA14::BitBang only connects to software drivers!");
	};
	template< Peripheral peripheral >
	struct Jtck { static void connect();
		static_assert(
			(peripheral == Peripheral::Sys),
			"GpioA14::Jtck only connects to Sys!");
	};
	template< Peripheral peripheral >
	struct Swclk { static void connect();
		static_assert(
			(peripheral == Peripheral::Sys),
			"GpioA14::Swclk only connects to Sys!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
/// @cond
template<>
struct GpioA14::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioA14;
...
template<>
struct GpioA14::Jtck<Peripheral::Sys>
{
	using Gpio = GpioA14;
...
template<>
struct GpioA14::Swclk<Peripheral::Sys>
{
	using Gpio = GpioA14;
...
#endif // MODM_STM32_GPIO_PIN_A14_HPP