...
public:
	...
	struct Bk1Io1 { static void connect();
		static_assert(
			...
			"GpioB0::Bk1Io1 only connects to Quadspi!");
	};
	template< Peripheral peripheral >
	...
	struct Ck { static void connect();
		static_assert(
			...
			"GpioB0::Ck only connects to Usart3!");
	};
	template< Peripheral peripheral >
	struct In15 { static void connect();
		static_assert(
			...
			"GpioB0::In15 only connects to Adc1 or Adc2!");
	};
	template< Peripheral peripheral >
	struct Out { static void connect();
		static_assert(
			(peripheral == Peripheral::Comp1),
			"GpioB0::Out only connects to Comp1!");
	};
	template< Peripheral peripheral >
	struct Seg5 { static void connect();
		static_assert(
			(peripheral == Peripheral::Lcd),
			"GpioB0::Seg5 only connects to Lcd!");
	};
	template< Peripheral peripheral >
	struct Vout { static void connect();
		static_assert(
			(peripheral == Peripheral::Opamp2),
			"GpioB0::Vout only connects to Opamp2!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
template<>
struct GpioB0::Bk1Io1<Peripheral::Quadspi>
{
	using Gpio = GpioB0;
...
template<>
struct GpioB0::Ck<Peripheral::Usart3>
{
	using Gpio = GpioB0;
...
template<>
struct GpioB0::In15<Peripheral::Adc1>
{
	using Gpio = GpioB0;
...
template<>
constexpr int8_t
GpioB0::AdcChannel<Peripheral::Adc1> = 15;
template<>
struct GpioB0::In15<Peripheral::Adc2>
{
	using Gpio = GpioB0;
	static constexpr Gpio::Signal Signal = Gpio::Signal::In15;
	static constexpr int af = -1;
...
template<>
constexpr int8_t
GpioB0::AdcChannel<Peripheral::Adc2> = 15;
template<>
struct GpioB0::Out<Peripheral::Comp1>
{
	using Gpio = GpioB0;
...
template<>
struct GpioB0::Seg5<Peripheral::Lcd>
{
	using Gpio = GpioB0;
...
template<>
struct GpioB0::Vout<Peripheral::Opamp2>
{
	using Gpio = GpioB0;
