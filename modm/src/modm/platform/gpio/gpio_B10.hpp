...
public:
	...
	struct Clk { static void connect();
		static_assert(
			...
			"GpioB10::Clk only connects to Quadspi!");
	};
	template< Peripheral peripheral >
	struct Datin7 { static void connect();
		static_assert(
			(peripheral == Peripheral::Dfsdm1),
			"GpioB10::Datin7 only connects to Dfsdm1!");
	};
	template< Peripheral peripheral >
	struct Out { static void connect();
		static_assert(
			(peripheral == Peripheral::Comp1),
			"GpioB10::Out only connects to Comp1!");
	};
	template< Peripheral peripheral >
	struct Rx { static void connect();
		static_assert(
			(peripheral == Peripheral::Lpuart1),
			"GpioB10::Rx only connects to Lpuart1!");
	};
	template< Peripheral peripheral >
	...
	template< Peripheral peripheral >
	struct Seg10 { static void connect();
		static_assert(
			(peripheral == Peripheral::Lcd),
			"GpioB10::Seg10 only connects to Lcd!");
	};
	template< Peripheral peripheral >
...
template<>
struct GpioB10::Clk<Peripheral::Quadspi>
{
	using Gpio = GpioB10;
...
template<>
struct GpioB10::Datin7<Peripheral::Dfsdm1>
{
	using Gpio = GpioB10;
...
template<>
struct GpioB10::Out<Peripheral::Comp1>
{
	using Gpio = GpioB10;
...
template<>
struct GpioB10::Rx<Peripheral::Lpuart1>
{
	using Gpio = GpioB10;
...
template<>
struct GpioB10::Seg10<Peripheral::Lcd>
{
	using Gpio = GpioB10;
