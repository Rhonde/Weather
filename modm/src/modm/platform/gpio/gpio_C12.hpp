...
public:
	...
	/// Connect to Usart3 or Sdmmc1
	using Ck = GpioSignal;
	/// Connect to Lcd
	using Com6 = GpioSignal;
	/// Connect to Tsc
	using G3Io4 = GpioSignal;
	/// Connect to Spi3
	using Mosi = GpioSignal;
	/// Connect to Sai2
	using SdB = GpioSignal;
	/// Connect to Lcd
	using Seg30 = GpioSignal;
	/// Connect to Lcd
	using Seg42 = GpioSignal;
	/// Connect to Uart5
	using Tx = GpioSignal;
	/// @}
#endif
	...
	template< Peripheral peripheral >
	struct Com6 { static void connect();
		static_assert(
			(peripheral == Peripheral::Lcd),
			"GpioC12::Com6 only connects to Lcd!");
	};
	template< Peripheral peripheral >
	struct G3Io4 { static void connect();
		static_assert(
			(peripheral == Peripheral::Tsc),
			"GpioC12::G3Io4 only connects to Tsc!");
	};
	template< Peripheral peripheral >
	...
	struct SdB { static void connect();
		static_assert(
			...
			"GpioC12::SdB only connects to Sai2!");
	};
	template< Peripheral peripheral >
	struct Seg30 { static void connect();
		static_assert(
			(peripheral == Peripheral::Lcd),
			"GpioC12::Seg30 only connects to Lcd!");
	};
	template< Peripheral peripheral >
	struct Seg42 { static void connect();
		static_assert(
			(peripheral == Peripheral::Lcd),
			"GpioC12::Seg42 only connects to Lcd!");
	};
	template< Peripheral peripheral >
...
template<>
struct GpioC12::Ck<Peripheral::Sdmmc1>
{
	using Gpio = GpioC12;
	static constexpr Gpio::Signal Signal = Gpio::Signal::Ck;
...
template<>
struct GpioC12::Com6<Peripheral::Lcd>
{
	using Gpio = GpioC12;
...
template<>
struct GpioC12::G3Io4<Peripheral::Tsc>
{
	using Gpio = GpioC12;
...
template<>
struct GpioC12::SdB<Peripheral::Sai2>
{
	using Gpio = GpioC12;
...
template<>
struct GpioC12::Seg30<Peripheral::Lcd>
{
	using Gpio = GpioC12;
...
template<>
struct GpioC12::Seg42<Peripheral::Lcd>
{
	using Gpio = GpioC12;
