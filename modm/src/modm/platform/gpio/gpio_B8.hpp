...
#ifndef MODM_STM32_GPIO_PIN_B8_HPP
#define MODM_STM32_GPIO_PIN_B8_HPP
...
class GpioB8 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioB8>;
	friend class Adc;
...
/// @cond
template<>
struct GpioB8::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioB8;
...
template<>
struct GpioB8::Ch1<Peripheral::Tim16>
{
	using Gpio = GpioB8;
...
template<>
struct GpioB8::Ch3<Peripheral::Tim4>
{
	using Gpio = GpioB8;
...
template<>
struct GpioB8::D4<Peripheral::Sdmmc1>
{
	using Gpio = GpioB8;
...
template<>
struct GpioB8::Datin6<Peripheral::Dfsdm1>
{
	using Gpio = GpioB8;
...
template<>
struct GpioB8::MclkA<Peripheral::Sai1>
{
	using Gpio = GpioB8;
...
template<>
struct GpioB8::Rx<Peripheral::Can1>
{
	using Gpio = GpioB8;
...
template<>
struct GpioB8::Scl<Peripheral::I2c1>
{
	using Gpio = GpioB8;
...
template<>
struct GpioB8::Seg16<Peripheral::Lcd>
{
	using Gpio = GpioB8;
...
#endif // MODM_STM32_GPIO_PIN_B8_HPP