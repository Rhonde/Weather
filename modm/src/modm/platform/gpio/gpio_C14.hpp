...
#ifndef MODM_STM32_GPIO_PIN_C14_HPP
#define MODM_STM32_GPIO_PIN_C14_HPP
...
class GpioC14 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioC14>;
	friend class Adc;
	friend class Adc1; friend class Adc2;
	friend class Adc3; friend class Adc4;
public:
	using Output = GpioC14;
	using Input = GpioC14;
	using IO = GpioC14;
	using Type = GpioC14;
...
/// @cond
template<>
struct GpioC14::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioC14;
...
#endif // MODM_STM32_GPIO_PIN_C14_HPP