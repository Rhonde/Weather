...
public:
	...
	struct De { static void connect();
		static_assert(
			...
			"GpioA15::De only connects to Uart4!");
	};
	template< Peripheral peripheral >
	...
	struct FsB { static void connect();
		static_assert(
			...
			"GpioA15::FsB only connects to Sai2!");
	};
	template< Peripheral peripheral >
	struct G3Io1 { static void connect();
		static_assert(
			(peripheral == Peripheral::Tsc),
			"GpioA15::G3Io1 only connects to Tsc!");
	};
	template< Peripheral peripheral >
	...
	struct Rts { static void connect();
		static_assert(
			(peripheral == Peripheral::Uart4),
			"GpioA15::Rts only connects to Uart4!");
	};
	template< Peripheral peripheral >
	struct Seg17 { static void connect();
		static_assert(
			(peripheral == Peripheral::Lcd),
			"GpioA15::Seg17 only connects to Lcd!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
template<>
struct GpioA15::De<Peripheral::Uart4>
{
	using Gpio = GpioA15;
...
template<>
struct GpioA15::FsB<Peripheral::Sai2>
{
	using Gpio = GpioA15;
...
template<>
struct GpioA15::G3Io1<Peripheral::Tsc>
{
	using Gpio = GpioA15;
...
template<>
struct GpioA15::Rts<Peripheral::Uart4>
{
	using Gpio = GpioA15;
...
template<>
struct GpioA15::Seg17<Peripheral::Lcd>
{
	using Gpio = GpioA15;
