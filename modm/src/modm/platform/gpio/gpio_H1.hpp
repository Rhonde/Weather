...
#ifndef MODM_STM32_GPIO_PIN_H1_HPP
#define MODM_STM32_GPIO_PIN_H1_HPP
...
class GpioH1 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioH1>;
	friend class Adc;
...
/// @cond
template<>
struct GpioH1::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioH1;
...
#endif // MODM_STM32_GPIO_PIN_H1_HPP