...
#ifndef MODM_STM32_GPIO_PIN_A10_HPP
#define MODM_STM32_GPIO_PIN_A10_HPP
...
class GpioA10 : public Gpio, public ::modm::GpioIO
{
	template<class... Gpios>
	friend class GpioSet;
	using PinSet = GpioSet<GpioA10>;
	friend class Adc;
	friend class Adc1; friend class Adc2;
	friend class Adc3; friend class Adc4;
public:
	using Output = GpioA10;
	using Input = GpioA10;
	using IO = GpioA10;
	using Type = GpioA10;
...
/// @cond
template<>
struct GpioA10::BitBang<Peripheral::BitBang>
{
	using Gpio = GpioA10;
...
template<>
struct GpioA10::Bkin<Peripheral::Tim17>
{
	using Gpio = GpioA10;
...
template<>
struct GpioA10::Ch3<Peripheral::Tim1>
{
	using Gpio = GpioA10;
...
template<>
struct GpioA10::Com2<Peripheral::Lcd>
{
	using Gpio = GpioA10;
...
template<>
struct GpioA10::Id<Peripheral::UsbOtgFs>
{
	using Gpio = GpioA10;
...
template<>
struct GpioA10::Rx<Peripheral::Usart1>
{
	using Gpio = GpioA10;
...
#endif // MODM_STM32_GPIO_PIN_A10_HPP