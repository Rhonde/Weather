...
public:
	...
	template< Peripheral peripheral >
	struct Ckin4 { static void connect();
		static_assert(
			(peripheral == Peripheral::Dfsdm1),
			"GpioC1::Ckin4 only connects to Dfsdm1!");
	};
	template< Peripheral peripheral >
	struct In2 { static void connect();
		static_assert(
			...
			"GpioC1::In2 only connects to Adc1 or Adc2 or Adc3!");
	};
	template< Peripheral peripheral >
	...
	struct Sda { static void connect();
		static_assert(
			...
			"GpioC1::Sda only connects to I2c3!");
	};
	template< Peripheral peripheral >
	struct Seg19 { static void connect();
		static_assert(
			(peripheral == Peripheral::Lcd),
			"GpioC1::Seg19 only connects to Lcd!");
	};
	template< Peripheral peripheral >
...
template<>
struct GpioC1::Ckin4<Peripheral::Dfsdm1>
{
	using Gpio = GpioC1;
...
template<>
struct GpioC1::In2<Peripheral::Adc1>
{
	using Gpio = GpioC1;
...
template<>
constexpr int8_t
GpioC1::AdcChannel<Peripheral::Adc1> = 2;
template<>
struct GpioC1::In2<Peripheral::Adc2>
{
	using Gpio = GpioC1;
	static constexpr Gpio::Signal Signal = Gpio::Signal::In2;
	static constexpr int af = -1;
...
template<>
constexpr int8_t
GpioC1::AdcChannel<Peripheral::Adc2> = 2;
template<>
struct GpioC1::In2<Peripheral::Adc3>
{
	using Gpio = GpioC1;
	static constexpr Gpio::Signal Signal = Gpio::Signal::In2;
	static constexpr int af = -1;
...
template<>
constexpr int8_t
GpioC1::AdcChannel<Peripheral::Adc3> = 2;
template<>
...
template<>
struct GpioC1::Sda<Peripheral::I2c3>
{
	using Gpio = GpioC1;
...
template<>
struct GpioC1::Seg19<Peripheral::Lcd>
{
	using Gpio = GpioC1;
