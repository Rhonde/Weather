...
public:
	...
	struct BkinComp2 { static void connect();
		static_assert(
			(peripheral == Peripheral::Tim1) ||
			(peripheral == Peripheral::Tim8),
			"GpioA6::BkinComp2 only connects to Tim1 or Tim8!");
	};
	template< Peripheral peripheral >
	struct Ch1 { static void connect();
		static_assert(
			...
			"GpioA6::Ch1 only connects to Tim3 or Tim16!");
	};
	template< Peripheral peripheral >
	struct Cts { static void connect();
		static_assert(
			(peripheral == Peripheral::Usart3),
			"GpioA6::Cts only connects to Usart3!");
	};
	template< Peripheral peripheral >
	struct In11 { static void connect();
		static_assert(
			...
			"GpioA6::In11 only connects to Adc1 or Adc2!");
	};
	template< Peripheral peripheral >
	...
	template< Peripheral peripheral >
	struct Seg3 { static void connect();
		static_assert(
			(peripheral == Peripheral::Lcd),
			"GpioA6::Seg3 only connects to Lcd!");
	};
	template< Peripheral peripheral >
	struct Vinp { static void connect();
		static_assert(
			(peripheral == Peripheral::Opamp2),
			"GpioA6::Vinp only connects to Opamp2!");
	};
	/// @endcond
private:
	template< Peripheral peripheral >
...
template<>
struct GpioA6::Bkin<Peripheral::Tim8>
{
	using Gpio = GpioA6;
	static constexpr Gpio::Signal Signal = Gpio::Signal::Bkin;
...
template<>
struct GpioA6::BkinComp2<Peripheral::Tim8>
{
	using Gpio = GpioA6;
	static constexpr Gpio::Signal Signal = Gpio::Signal::BkinComp2;
...
template<>
struct GpioA6::Ch1<Peripheral::Tim3>
{
	using Gpio = GpioA6;
...
template<>
struct GpioA6::Cts<Peripheral::Usart3>
{
	using Gpio = GpioA6;
...
template<>
struct GpioA6::In11<Peripheral::Adc2>
{
	using Gpio = GpioA6;
	static constexpr Gpio::Signal Signal = Gpio::Signal::In11;
	static constexpr int af = -1;
...
template<>
constexpr int8_t
GpioA6::AdcChannel<Peripheral::Adc2> = 11;
template<>
...
template<>
struct GpioA6::Seg3<Peripheral::Lcd>
{
	using Gpio = GpioA6;
...
template<>
struct GpioA6::Vinp<Peripheral::Opamp2>
{
	using Gpio = GpioA6;
