...
public:
	...
	template< Peripheral peripheral >
	struct Ckin0 { static void connect();
		static_assert(
			(peripheral == Peripheral::Dfsdm1),
			"GpioB2::Ckin0 only connects to Dfsdm1!");
	};
	template< Peripheral peripheral >
	struct Inp { static void connect();
		static_assert(
			(peripheral == Peripheral::Comp1),
			"GpioB2::Inp only connects to Comp1!");
	};
	template< Peripheral peripheral >
	...
	struct OutAlarm { static void connect();
		static_assert(
			...
			"GpioB2::OutAlarm only connects to Rtc!");
	};
	template< Peripheral peripheral >
	struct OutCalib { static void connect();
		static_assert(
			(peripheral == Peripheral::Rtc),
			"GpioB2::OutCalib only connects to Rtc!");
	};
	template< Peripheral peripheral >
...
template<>
struct GpioB2::Ckin0<Peripheral::Dfsdm1>
{
	using Gpio = GpioB2;
...
template<>
struct GpioB2::Inp<Peripheral::Comp1>
{
	using Gpio = GpioB2;
...
template<>
struct GpioB2::OutAlarm<Peripheral::Rtc>
{
	using Gpio = GpioB2;
...
template<>
struct GpioB2::OutCalib<Peripheral::Rtc>
{
	using Gpio = GpioB2;
