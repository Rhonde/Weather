...
public:
	...
	struct In14 { static void connect();
		static_assert(
			...
			"GpioC5::In14 only connects to Adc1 or Adc2!");
	};
	template< Peripheral peripheral >
	struct Inp { static void connect();
		static_assert(
			(peripheral == Peripheral::Comp1),
			"GpioC5::Inp only connects to Comp1!");
	};
	template< Peripheral peripheral >
	...
	template< Peripheral peripheral >
	struct Seg23 { static void connect();
		static_assert(
			(peripheral == Peripheral::Lcd),
			"GpioC5::Seg23 only connects to Lcd!");
	};
	template< Peripheral peripheral >
...
template<>
struct GpioC5::In14<Peripheral::Adc1>
{
	using Gpio = GpioC5;
...
template<>
constexpr int8_t
GpioC5::AdcChannel<Peripheral::Adc1> = 14;
template<>
struct GpioC5::In14<Peripheral::Adc2>
{
	using Gpio = GpioC5;
	static constexpr Gpio::Signal Signal = Gpio::Signal::In14;
	static constexpr int af = -1;
...
template<>
constexpr int8_t
GpioC5::AdcChannel<Peripheral::Adc2> = 14;
template<>
struct GpioC5::Inp<Peripheral::Comp1>
{
	using Gpio = GpioC5;
...
template<>
struct GpioC5::Seg23<Peripheral::Lcd>
{
	using Gpio = GpioC5;
